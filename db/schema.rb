...
ActiveRecord::Schema[7.0].define(version: 2023_11_02_091651) do
  ...
  create_table "comment_down_votes", force: :cascade do |t|
    t.boolean "is_clicked", default: true
    t.bigint "comment_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["comment_id"], name: "index_comment_down_votes_on_comment_id"
  end

  create_table "comment_up_votes", force: :cascade do |t|
    t.boolean "is_clicked", default: true
    t.bigint "comment_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["comment_id"], name: "index_comment_up_votes_on_comment_id"
  end
  ...
  create_table "post_up_votes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["post_id"], name: "index_post_up_votes_on_post_id"
  end
  ...
  create_table "reply_up_votes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["reply_id"], name: "index_reply_up_votes_on_reply_id"
  end
  ...
  create_table "subjects", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "subject_coverage_id"
    t.index ["name"], name: "index_subjects_on_name", unique: true
    t.index ["subject_coverage_id"], name: "index_subjects_on_subject_coverage_id"
  end
  ...
  add_foreign_key "comment_down_votes", "comments"
  add_foreign_key "comment_up_votes", "comments"
